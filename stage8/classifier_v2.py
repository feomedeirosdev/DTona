...
from yellowbrick import classifier # ROCAUC
from yellowbrick import datasets #load_spam
...
model = tree.DecisionTreeClassifier(min_samples_leaf=100, random_state=42)
...
model_logreg = linear_model.LogisticRegression(multi_class="auto", solver="liblinear")
visualizer = classifier.ROCAUC(model_logreg, classes=["No Churn", "Churn"])
...
# %%
y_train_proba = model_logreg.predict_proba(df_train[features_fit])
